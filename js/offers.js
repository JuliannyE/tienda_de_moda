...
function agregarAlCarrito(index) {
    const producto = productosConOferta[index]
    agregarProducto({ ...producto, precio: producto.precioFinal })
...
function cargarProductos() {
    let innerProducts = ""
    productosConOferta.forEach((p, index) => {
        ...
        <div class="collage-element">
            ...
            <div class="main-offers">
                <b class="item-price">${p.precio.toFixed(2)} $</b>
                <b class="item-discount">${p.precioFinal.toFixed(2)} $</b>
            </div>
